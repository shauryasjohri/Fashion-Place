  ...
  return (
    <button
      className={clsx(
        ...
        "focus:outline-none",
        "dark:(bg-gray-200 text-gray-900 hover:bg-gray-300 focus:ring-gray-500)",
        (secondary || link) && "!bg-transparent !shadow-none",
        link && "!text-blue-800 dark:!text-blue-400 hover:!text-blue-900 dark:hover:!text-blue-300",
        (secondary || light) && "!text-gray-800 dark:!text-gray-200",
        light && "!bg-white dark:!bg-gray-700 !hover:bg-gray-200 dark:!hover:bg-gray-600",
